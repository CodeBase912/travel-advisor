  ...
  return (
    <Box
      className={classNames(
        "p-2 overflow-y-scroll space-y-8",
        ...
        ? searchState.result?.list.map(({ singleCardContent }, itemIndex) => {
            ...
            return (
              <Box
                ...
                className="flex flex-col rounded-lg overflow-hidden border border-gray-400 cursor-pointer"
              >
                {/* Image Wrapper */}
                ...
                {/* Content Wrapper */}
                <Box className="py-2 px-5 w-full space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="w-[20px] h-[20px] mr-2">
                      <svg width="100%" height="100%" viewBox="0 0 544 450.266">
                        <path
                          id="Path_1"
                          data-name="Path 1"
